...
export class UnitTestRunner {
	...
	timeout = 5 * 60 * 1000 * (env.CODE_COVERAGE ? 2 : 1)
	port = 8085
	...
	updateResults(message, pass = false) {
...
class CodeCoverage {
	...
	totalPercent = ""
	linesSummery = { hit: "", total: "" }
	filesSummery = { hit: "", total: "" }
	coveredFiles = []
	missedFiles = []
	...
	parseForTotalCoverageAndLineSummery(line) {
	...
	parseForFilesMissedAndCoveredFiles(line) {
